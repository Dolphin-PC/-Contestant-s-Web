...
class ColTabs extends React.Component {
   ...
   componentDidMount() {
      ...
      teamList_Ref.child(`${selectedSeason}/${detailTitle}/team_member/${user.userName}`).once(
         "value",
         function (snapShot) {
            if (snapShot.exists()) {
               ...
               buttons: [
                  {
                     ...
                     onClick: () => {
                        ...
                        teamList_Ref.child(`${selectedSeason}/${detailTitle}/teamDay/${title}`).update({
                           opinion: this.editorOpinionRef.current.getInstance().getHtml(),
                           feedback: this.editorFeedbackRef.current.getInstance().getHtml(),
      ...
      return (
         <>
            ...
            <BsFillTrashFill onClick={this.props.trashClickEvent} />
               ...
               {/* <br /> */}
               <button aria-label="Close" className="close" type="button">
                  {isEditable ? <BsCheckBox onClick={this.handleChangeMeetingLog} /> : <BsPencilSquare onClick={this.handleChangeMeetingLog} />}
               </button>
            </h3>
            <Row className="justify-content-center">
               <Col lg="12">
                  {/* Menu */}
                  <div className="mb-3">
                     <small className="text-uppercase font-weight-bold">{this.props.subtitle}</small>
                  </div>
                  <div className="nav-wrapper">
                     <Nav className="nav-fill flex-md-row" id="tabs-icons-text" pills role="tablist">
                        <NavItem>
                           <NavLink
                     ...
                     <CardBody>
                        <TabContent activeTab={"plainTabs" + this.state.plainTabs}>
                           <TabPane tabId="plainTabs1">
                              {isEditable ? (
                                 <div>
                                    <Editor initialValue={this.props.opinion} previewStyle="vertical" height="600px" initialEditType="wysiwyg" useCommandShortcut={true} ref={this.editorOpinionRef} />
                                 </div>
                              ) : (
                                 <div>
                           ...
                           <TabPane tabId="plainTabs3">
                              {isEditable ? (
                                 <div>
                                    <Editor initialValue={this.props.etc} previewStyle="vertical" height="600px" initialEditType="wysiwyg" useCommandShortcut={true} ref={this.editorEtcRef} />
                                 </div>
                              ) : (
                                 <div>
               ...
               <Col lg="12">
                  <FeedbackAccordion userUID={this.props.user.userUID} selectedSeason={this.props.selectedSeason} detailTitle={this.props.detailTitle} meetingLog={this.props.title} />
                  <FeedbackTextField selectedSeason={this.props.selectedSeason} detailTitle={this.props.detailTitle} meetingLog={this.props.title} />
               </Col>
            </Row>
         </>
      );
