...
class FeedbackTextField extends React.Component {
   ...
   handleOnClick = () => {
      ...
      if (this.state.value !== "") {
         var newPostKey = Ref.teamList_Ref.child(`${selectedSeason}/${detailTitle}/teamDay/${meetingLog}/feedbacks`).push().key;

         Ref.teamList_Ref.child(`${selectedSeason}/${detailTitle}/teamDay/${meetingLog}/feedbacks/${newPostKey}`).set({
      ...
      return (
         <form noValidate autoComplete="off">
            <Row>
               ...
               <Col lg="3">
                  <Button color="primary" outline id="FeedbackButton" onClick={this.handleOnClick}>
                     POST
                  </Button>
               </Col>
            </Row>
